...
#' download its output and prepare it for analysis. It allows you to create custom queries
...
#' 
#' The main element of this package is the \code{\link{rw.query}} function.
